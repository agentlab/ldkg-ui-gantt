...
const tasks = [
  ...
  },
  {
    ...
    user: (
      <a
        href="https://www.google.com/search?q=Peter+Parker"
        target="_blank"
        style={{ color: "#0077c0" }}
      >
        Peter Parker
  ...
  },
  {
    ...
    user: (
      <a
        href="https://www.google.com/search?q=John+Wayne"
        target="_blank"
        style={{ color: "#0077c0" }}
      >
        John Wayne
  ...
  },
  {
    ...
    user: (
      <a
        href="https://www.google.com/search?q=Clark+Kent"
        target="_blank"
        style={{ color: "#0077c0" }}
      >
        Clark Kent
  ...
  },
  {
    ...
    user: (
      <a
        href="https://www.google.com/search?q=Austin+Powers"
        target="_blank"
        style={{ color: "#0077c0" }}
      >
        Austin Powers
  ...
  },
  {
    ...
    user: (
      <a
        href="https://www.google.com/search?q=Mario+Bros"
        target="_blank"
        style={{ color: "#0077c0" }}
      >
        Mario Bros
  ...
  },
  {
    ...
    user: (
      <a
        href="https://www.google.com/search?q=Knight+Rider"
        target="_blank"
        style={{ color: "#0077c0" }}
      >
        Knight Rider
  ...
  },
  {
    ...
    user: (
      <a
        href="https://www.google.com/search?q=Johhny+Bravo"
        target="_blank"
        style={{ color: "#0077c0" }}
      >
        Johhny Bravo
  ...
  },
  {
    ...
    user: (
      <a
        href="https://www.google.com/search?q=Dexter\'s+Laboratory"
        target="_blank"
        style={{ color: "#0077c0" }}
      >
        Dexter's Laboratory
